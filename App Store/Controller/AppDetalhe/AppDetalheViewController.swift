//
//  AppDetalheViewController.swift
//  App Store
//
...
class AppDetalheViewController: UICollectionViewController, UICollectionViewDelegateFlowLayout{
    
    let headerId = "headerId"
    let descricaoId = "descricaoId"
    let screenShotId = "screenShotId"
    let detalheAvaliacaoId = "detalheAvaliacaoId"
    ...
    override func viewDidLoad() {
        ...
        collectionView.register(AppDetalheAvaliacaoCell.self, forCellWithReuseIdentifier: detalheAvaliacaoId)
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if indexPath.item == 3 {
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: detalheAvaliacaoId, for: indexPath) as! AppDetalheAvaliacaoCell
            cell.app = self.app
            return cell
        }
